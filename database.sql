...
INSERT INTO "todoList" ("task", "deadline")
    VALUES
    ('Celebrate Christmas!', '2022-25-12'),
    ('Dominate in neighborhood snowball fight @ 12pm', '2022-21-12'),
    ('Wrap the rest of the presents', '2022-23-12'),
    ('Yearly pondering of the incomprehensible insignificance of our species` existence from a cosmic perspective', '2023-01-01'),
    ('Back to class for Week 9!', '2023-01-02');

INSERT INTO "completedList" ("task", "dateCompleted")
    VALUES
    ('Finish Week 8 Weekend Challenge', 'Sun Dec 18 2022 18:00:00 GMT-0600 (Central Standard Time)'),
    ('Complete shopping for holiday gifts', 'Sat Dec 17 2022 11:38:19 GMT-0600 (Central Standard Time)'),
